...
{{if not .service}}No service given, so start with fleet triage: call get_alerts to find firing alerts, then get_service_summary to spot the unhealthy services, and scope the branch below to the worst offender.
