...
- If no specific filter is needed for aggregation, create a match-all filter using correct trace_id or span_id filters based on standard fields or fields returned by `get_trace_attributes`
