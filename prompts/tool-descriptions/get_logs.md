...
- If no specific filter is needed for aggregation, create a match-all filter using correct body or service filters based on the server-fetched log attributes list
