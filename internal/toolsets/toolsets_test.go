...
func TestParseInvestigate(t *testing.T) {
	...
	for _, want := range []string{"get_logs", "get_traces", "get_trace_attribute_deviations", "get_trace_waterfall", "prometheus_instant_query", "did_you_mean", "list_datasources", "get_apm_service_deviations"} {
		if !set.Allows(want) {
